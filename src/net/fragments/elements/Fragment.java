...
import net.fragments.FragmentFactory;
import net.fragments.FragmentSettings;
import net.fragments.IFragmentContext;
import net.fragments.PageWithFragments;
import net.fragments.events.FragmentEvent;
import net.fragments.events.FragmentEventBus;
import net.fragments.locators.DefaultElementLocator;
import net.fragments.utils.JSActions;
import net.fragments.utils.PageUtils;
...
import static net.fragments.utils.XPathFunctions.containstext;

public class Fragment<Parent extends IFragmentContext> implements WebElement, WrapsElement, IFragmentContext {
	
	/**
	 * Injected with {@link net.fragments.FragmentFactory}
	 */
